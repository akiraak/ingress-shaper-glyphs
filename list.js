$(function () {
	...
	function updateColumnsVisibility() {
		var altsColumn = grid.columns.findWhere({
				"name" : "en_alts"
			});
		var l10nAltsColumn = grid.columns.findWhere({
				"l10n" : true,
				"alts" : true
			});
		var l10nColumn = grid.columns.findWhere({
				"l10n" : true,
				"alts" : false
			});
		var flatten = $("#flatten").is(":checked");
		var translate = !_.isUndefined(_.findWhere(langs, {
					"code" : $("#lang").val()
				}));
